			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="collapse dont-collapse-sm contacts" id="collapse_3">
						<ul>
							<li><i class="ti-home"></i>3736-30200 Kitale<br>KENYA</li>
							<li><i class="ti-headphone-alt"></i>+254 740567299</li>
							<li><i class="ti-email"></i><a href="#0">info@thereads.com</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
			...
			<div class="row add_bottom_25">
				...
				<div class="col-lg-6">
					<ul class="additional_links">
						...
						<li><span>© 2023 THE READS</span></li>
					</ul>
				</div>
			</div>
		</div>
